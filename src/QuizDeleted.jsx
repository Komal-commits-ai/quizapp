...
export default function QuizDeleted() {
            ...
            <div className="w-full max-w-4xl bg-white rounded-3xl p-8 md:p-12 shadow-2xl">
                <div className="flex flex-col items-center text-center py-6 md:py-10 px-4">
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 mb-8 font-medium">
                        You have successfully deleted the quiz!
                    </p>
                    
    
                    <div className="bg-gray-50 rounded-xl p-6 w-full max-w-md mb-8">
                        <p className="text-gray-600 mb-2">You can delete more quiz or create new ones by clicking on below button.</p>
                        
                    </div>
                    <button className="p-7 rounded-3xl bg-gradient-to-br from-green-500 to-teal-600 text-white hover:text-2xl hover:-translate-2" onClick={()=>navigate("/managequiz")}>BACK</button>
                </div>
            </div>
        </div>
    );
